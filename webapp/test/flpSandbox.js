		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Customers",
									"targetURL": "#btpacademycustomers-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"btpacademycustomers-display": {
								"semanticObject": "btpacademycustomers",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=btp.academy.customers",
									"url": sap.ui.require.toUrl("btp/academy/customers")
								}
							}
						}
					}
